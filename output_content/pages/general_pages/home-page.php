        ...
        <div class="flex flex-col w-full relative gap-30 z-[1]">
            ...
            <div id="search_container" class="flex flex-col max-w-150 items-start">
                ...
                <label for="searchBar" class="group hover:!border-[#fff] focus-within:!border-[#fff] !flex !py-[12px] border-b border-[#fff] w-full gap-[10px] items-center">
                    ...
                    <input type="text" name="text" id="searchBar" class="autofill:bg-[#000] group-[.active]:!text-[#fff] group-hover:!text-[#fff] group-focus-within:!text-[#fff] !border-0 !outline-none !h-fit !text-[29.04px] !leading-[1.6] !!font-['Poppins',sans-serif] !text-[#fff] w-full" placeholder="Enter the search term here...">
                </label>
            </div>
        </div>
    </div>
