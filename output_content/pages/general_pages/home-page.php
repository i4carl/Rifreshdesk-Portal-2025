    ...
    <div class="flex flex-col w-full min-h-[533px] relative p-9">
        <div class="absolute w-full h-full flex top-0 left-0">
            <div class="flex-1 h-full overflow-hidden">
                ...
                <div class="w-full h-full bg-[url('https://cdn.jsdelivr.net/gh/i4carl/Rifreshdesk-Portal-2025@ee36993ef76f9f6d8a51665d81edca8dfe08467d/assets/homepage/homepage-banner-new.jpg')] bg-fixed bg-center"></div>
    ...
    <div class="w-full bg-[#145082] pt-[66px] !pb-[88px] px-6 gap-14 flex flex-col">
        <div class="gap-3 flex flex-col">
            ...
            <div class="px-0 sm:!px-6 py-3 gap-6 flex flex-wrap">
                <div class="flex-1 py-[30px] gap-6 flex h-[135px] text-white min-w-[650px]">
